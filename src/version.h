...
#define PLUGIN_NAME "LOICollection"
#define PLUGIN_INTRODUCTION "Multifunctional plug-in set"
#define PLUGIN_AUTHOR "Tietu"
...
#define FILE_VERSION_LEGAL_COPYRIGHT "Copyright (C) 2024 Tietu"
